...
public class Timekeeper {
  ...
  int realSecondsPerFrame = 1000; // simulated seconds per frame
  float timescale = 1.0;
  ...
  public void advance() {
    cSimDate.setTimeInMillis((long) (cSimDate.getTimeInMillis() + 1000 * realSecondsPerFrame * timescale));
  }
  
  public long getMillisPerFrame() {
    return 1000 * realSecondsPerFrame;
  }
